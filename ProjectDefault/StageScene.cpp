...
void StageScene::RenderScene()
{
	...
	{
		case 1:
			Animator1->PlayAnimation(0, 0, 3.6, 10);
			break;
		case 2:
			Animator2->PlayAnimation(0, 0, 3.6, 10);
			break;
		case 3:
			Animator3->PlayAnimation(0, 0, 3.6, 10);
			break;
		case 4:
			Animator4->PlayAnimation(0, 0, 3.6, 10);
			break;
		case 5:
			Animator5->PlayAnimation(0, 0, 3.6, 10);
			break;
		default:
			break;
	}
