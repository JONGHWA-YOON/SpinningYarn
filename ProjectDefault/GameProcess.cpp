...
void GameProcess::Initialize_Sprites()
{
	...
	m_pD2DEngine->LoadSpriteSheet("Resources/UI/Color/black.png", eObjectDefine::BACK_BLACK);
	m_pD2DEngine->LoadSpriteFromSheet(eObjectDefine::BACK_BLACK, 0, 0, 1920, 1080, 1);
	...
	m_pD2DEngine->LoadSpriteSheet("Resources/UI/Shop_X.png", eObjectDefine::SHOP_CLOSE);
	...
	/// Tutorial
	m_pD2DEngine->LoadSpriteSheet("Resources/Tutorial/Tutor_1.png", eObjectDefine::Tutor_1);
	m_pD2DEngine->LoadSpriteFromSheet(eObjectDefine::Tutor_1, 0, 0, 600, 200, 0);

	m_pD2DEngine->LoadSpriteSheet("Resources/Tutorial/Tutor_2.png", eObjectDefine::Tutor_2);
	m_pD2DEngine->LoadSpriteFromSheet(eObjectDefine::Tutor_2, 0, 0, 600, 200, 0);

	m_pD2DEngine->LoadSpriteSheet("Resources/Tutorial/Tutor_3.png", eObjectDefine::Tutor_3);
	m_pD2DEngine->LoadSpriteFromSheet(eObjectDefine::Tutor_3, 0, 0, 600, 200, 0);

	m_pD2DEngine->LoadSpriteSheet("Resources/Tutorial/Tutor_4.png", eObjectDefine::Tutor_4);
	m_pD2DEngine->LoadSpriteFromSheet(eObjectDefine::Tutor_4, 0, 0, 600, 200, 0);

	m_pD2DEngine->LoadSpriteSheet("Resources/Tutorial/Tutor_5.png", eObjectDefine::Tutor_5);
	m_pD2DEngine->LoadSpriteFromSheet(eObjectDefine::Tutor_5, 0, 0, 600, 200, 0);

	m_pD2DEngine->LoadSpriteSheet("Resources/Tutorial/Tutor_6.png", eObjectDefine::Tutor_6);
	m_pD2DEngine->LoadSpriteFromSheet(eObjectDefine::Tutor_6, 0, 0, 600, 200, 0);

	m_pD2DEngine->LoadSpriteSheet("Resources/Tutorial/Tutor_7_1.png", eObjectDefine::Tutor_7_1);
	m_pD2DEngine->LoadSpriteFromSheet(eObjectDefine::Tutor_7_1, 0, 0, 600, 200, 0);

	m_pD2DEngine->LoadSpriteSheet("Resources/Tutorial/Tutor_7_2.png", eObjectDefine::Tutor_7_2);
	m_pD2DEngine->LoadSpriteFromSheet(eObjectDefine::Tutor_7_2, 0, 0, 600, 200, 0);

	m_pD2DEngine->LoadSpriteSheet("Resources/Tutorial/Tutor_8.png", eObjectDefine::Tutor_8);
	m_pD2DEngine->LoadSpriteFromSheet(eObjectDefine::Tutor_8, 0, 0, 600, 200, 0);

	m_pD2DEngine->LoadSpriteSheet("Resources/Tutorial/Tutor_9.png", eObjectDefine::Tutor_9);
	m_pD2DEngine->LoadSpriteFromSheet(eObjectDefine::Tutor_9, 0, 0, 600, 200, 0);
}
